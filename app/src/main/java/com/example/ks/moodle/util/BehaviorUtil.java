...
public class BehaviorUtil {
     ...
     * 是否自动埋点
     */
    public static boolean isAutoCollectEvent() { return isAutoCollectEvent; } /**
     * 设置是否自动埋点
     */
    public static void setAutoCollectEvent(boolean isAutoCollectEvent) { BehaviorUtil.isAutoCollectEvent = isAutoCollectEvent; }

...
public class Carame  extends AppCompatActivity implements SurfaceHolder.Callback,
        ...
        private static final String TAG = Carame.class.getSimpleName();

        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.ing2);
        ...
        private Runnable timerRunnable = new Runnable() {
            ...
            public void run() {
                if (mCurrentTimer > 0) {
                    ...
                    mCamera.takePicture(null, null, null, Carame.this);
                    playSound();
